        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedMenus = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeSlotLabel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowInOffersPopup = table.Column<bool>(type: "bit", nullable: false),
                    OfferFlyerUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Category = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkSchedules_Bookings_BookingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingEmployee", x => new { x.BookingsId, x.AssignedEmployeesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingEmployee_Employees_AssignedEmployeesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingEmployee_AssignedEmployeesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkSchedules_BookingId",
                table: "WorkSchedules",
                column: "BookingId");
        }
